                                       ...
                                       <div class="message_wrapper">
                                          ...
                                          if ($data['status_lulus'] == 'l') : ?> <!--lulus -->
                                             <blockquote class="message">
                                                ...
                                                <form action="<?= base_url(); ?>MhsDashboard/arsip/<?= $data['no_sertifikat'] ?>" method="post" enctype="multipart/form-data" target="_blank">
                                                   <input type="hidden" name="semester_akademik" value="<?= $data['semester_akademik'] ?>">
                                                   <input type="hidden" name="tahap_ke" value="<?= $data['tahap_ke'] ?>">
                                                   <button type="submit" class="btn btn-success"><i class="fa fa-file-image-o m-right-xs"></i> Download Sertifikat</button>
                                                </form>
                                             </blockquote>
