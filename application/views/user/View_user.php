...
<div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>Robi Dinnoor</td>
                          <td>robidinnoor@uin-antasari.ac.id</td>
                          <td>Aktif</td>
                          <td>edit</td>
                        </tr>
                      </tbody>
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate>
                      <span class="section">Informasi User</span>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="nama lengkap" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
